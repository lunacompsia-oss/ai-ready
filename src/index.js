...
async function createConfigPr(core, result) {
  ...
  try {
    ...
    const prBody = [
      ...
      '',
      'This PR adds AI coding tool configuration files generated by [ai-ready](https://github.com/lunacompsia-oss/ai-ready).',
      '',
      '### Generated Files',
      ...
      '',
      '---',
      '*Generated by [ai-ready](https://github.com/lunacompsia-oss/ai-ready) — AI Readiness scorer and config generator*',
    ].join('\n');
